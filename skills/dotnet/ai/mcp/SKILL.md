...
description: |
  ...
  USE FOR: building MCP tool servers, consuming MCP tools from AI agents, exposing .NET functions as MCP tools, providing resources and prompts to LLM clients, integrating MCP with Semantic Kernel
