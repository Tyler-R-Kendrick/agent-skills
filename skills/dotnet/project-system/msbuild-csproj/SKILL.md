...
name: msbuild-csproj
description: >
  USE FOR: Structuring MSBuild .csproj files, Directory.Build.props, Directory.Packages.props,
  Central Package Management, and dotnet CLI workflows for modern .NET project scaffolding.
  DO NOT USE FOR: Hand-editing .csproj XML directly (use dotnet CLI), runtime application
  configuration (use appsettings.json), or build scripting (use Cake or NUKE).
license: MIT
metadata:
  displayName: MSBuild CSPROJ
